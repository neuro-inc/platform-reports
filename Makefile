...
.PHONY: test-unit
test-unit:
	poetry run pytest -vv --log-level=INFO --cov-config=pyproject.toml -cov=src/platform_reports --cov-report xml:.coverage.unit.xml tests/unit

.PHONY: test-integration
test-integration:
	poetry run pytest -vv --log-level=INFO --cov-config=pyproject.toml -cov=src/platform_reports --cov-report xml:.coverage.integration.xml tests/integration
